...
describe OnboardingFormService do
  ...
  context 'prepare the zendesk ticket' do
    ...
    it 'should generate a valid zendesk ticket' do
      ...
      expect(OnboardingFormService.new().generate_ticket_body(form)).to eq({
         requester: {
             name: 'username',
    ...
    it 'should generate config files for a valid form' do
      ...
      expect(OnboardingFormService.new().generate_config_files(form)).to eq(expected_config_files)
